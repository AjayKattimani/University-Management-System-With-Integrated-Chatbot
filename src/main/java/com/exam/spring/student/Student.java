...
public class Student {
    ...
    public Student(Integer id, String name, String father_name, String mother_name, String email, String phone,
                   ...
                   String quta, Integer departmentcode, String departmentname, String password) {
        super();
        this.id = id;
        this.name = name;
	...
	public String toString() {
		return "Student [id=" + id + ", name=" + name + ", father_name=" + father_name + ", mother_name=" + mother_name
				+ ", email=" + email + ", phone=" + phone + ", address=" + address + ", birthdate=" + birthdate
				+ ", blood_group=" + blood_group + ", photo=" + photo + ", gender=" + gender + ", semester_fee="
				+ semester_fee + ", quta=" + quta + ", departmentcode=" + departmentcode + ", departmentname="
				+ departmentname + ", password=" + password + "]";
	}
