...
public class AdminPaymentController {
    ...
    @GetMapping("/createadminpayment/{id}")
    ...
    @PostMapping("/addadminpayment")
    public String AddAdminPayment(@ModelAttribute AdminPayment adminpayment, @RequestParam int tutionfee,
            @RequestParam int specialfee, @RequestParam int facilitesfee, @RequestParam int libraryfee,
            @RequestParam int fechnologyfee, @RequestParam int regfee, @RequestParam int housingfee,
            @RequestParam int financialaid, @RequestParam int studentidfee, @RequestParam String quta) {
