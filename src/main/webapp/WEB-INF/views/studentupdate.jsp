...
<div class="col py-3">
	...
	<ul class="nav nav-tabs">
		<li class="nav-item"><a class="nav-link" href="/addstudentform">
				<button type="button" class="btn" data-bs-toggle="modal"
					data-bs-target="#exampleModal">Add Student</button>
		</a></li>


		<li class="nav-item"><a class="nav-link" href="/showstudent"><button
					class="btn">View Student</button></a></li>
	...
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-10">
				<form class="row g-3 shadow p-3 rounded-2  bg-info"
					action="/studentupdate" method="post">
					...
					<div class="col-md-6">
						<label for="inputPassword4" class="form-label">Student
							Name</label> <input type="text" class="form-control" id="inputPassword4"
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control" id="inputPassword4"
							name="mother_name" value=${s.mother_name}>
					</div>
					<div class="col-12">
					...
					<div class="col-md-6">
						<label for="inputEmail4" class="form-label">Birth date</label> <input
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control" id="inputPassword4"
							name="blood_group" value=${s.blood_group}>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<label for="inputEmail4" class="form-label">Semester Fee</label> <input
							type="text" class="form-control" id="inputEmail4"
