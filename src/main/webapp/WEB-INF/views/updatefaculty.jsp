		...
		<div class="row justify-content-center">
			...
			<div class="col-10">
				<form class="row g-3 shadow p-3 rounded-2  bg-info"
					action="/updatefaculty" method="post">
					<h4 class="text-center">Update Faculty Information</h4>
					<div class="col-md-6">
						<label for="inputPassword4" class="form-label">Faculty Id</label>
	              ...
	              <div class="col-md-6">
						<label for="inputPassword4" class="form-label">Faculty
						...
						<div class="col-md-6">
							<label for="inputPassword4" class="form-label">Phone</label> <input
						...
						<div class="col-md-6">
							<label for="id" class="form-label">Department Name</label> <select
						...
						<!-- Add other fields for updating faculty information -->
