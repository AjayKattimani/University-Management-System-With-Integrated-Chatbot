...
<div class="col py-3">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link" href="/addstudentform">
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Student</button>
            </a>
        </li>
        <li class="nav-item">
            ...
            <div class="col-10">
                <form class="row g-3 shadow p-3 rounded-2" action="/addstudent" method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputPassword4" name="mother_name">
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="inputEmail4" name="birthdate">
                    </div>
                    <div class="col-md-6">
                        <label for="inputPassword4" class="form-label">Blood Group</label>
                        <input type="text" class="form-control" id="inputPassword4" name="blood_group">
                    </div>
                    <div class="col-md-6">
                        <label for="id" class="form-label">Gender</label>
                        <select name="gender" class="form-select" aria-label="Default select example" id="id">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" name="semester_fee">
                    </div>
                    <div class="col-md-6">
                        <label for="id" class="form-label">Quota</label>
                        <select name="quta" class="form-select" aria-label="Default select example" id="id">
